...
const CARD_SCENE_PATH ="res://LSQ/scene2/card1.tscn"
...
func _ready() -> void:
	...
	add_to_group("deck1")#用来解决节点不在一起的情况
...
func draw_card(card_count):
	...
	for i in range(card_count):
		...
		print(card_drawn_color)
		print(card_drawn_function)
		...
		#remove_child!!!!!
		new_card.name = "Card"
		$"../PH1online".add_card_to_hand(new_card)
